...
assert(~result.event_results(1).cancelled_job_backflow_detected, ...
    'First event should not report cancelled job backflow.');
assert(~result.event_results(2).cancelled_job_backflow_detected, ...
    'Second event should not report cancelled job backflow.');
