...
save(fullfile(runDir, 'medium_nsga2_result.mat'), ...
...
if isequal(fid, -1)
    error('run_medium_nsga2:SummaryOpenFailed', ...
        'Could not open summary file: %s', summaryPath);
end
cleanupObj = onCleanup(@() fclose(fid));
fprintf(fid, 'medium NSGA-II result\n');
...
fprintf('medium NSGA-II finished.\n');
...
if isequal(fid, -1)
    error('run_medium_nsga2:RunInfoOpenFailed', ...
